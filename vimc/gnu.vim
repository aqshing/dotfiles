" This file is copy by gnu's github.
" I also don't know what is this.
" 把GNU风格的代码(同时使用space和tab=8缩进,据说是RSM的趣味)
" 转换为space=tab=4的缩进。官方是这么说的，反正我也没用过...
" https://gcc.gnu.org/git/?p=gcc.git;a=blob;f=contrib/vimrc;hb=HEAD
" -------------------------------------------------------------
